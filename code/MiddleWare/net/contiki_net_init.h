...
/*********************************************************************************************************
  MAC地址定义   （EUI-64地址）
*********************************************************************************************************/
//#define LINK_ADDR_DEFAULT       {{0x02,0x00,0x00,0xff,0xfe,0x00,(get_moteid()>>8 & 0xff ),(get_moteid() & 0xff)}}
#define LINK_ADDR_DEFAULT       {{0x02,0x00,0x00,0xff,0xfe,0x00,0x00,0x00}}
